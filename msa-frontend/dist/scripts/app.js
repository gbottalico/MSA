...
function getMSAC() {
	var msac = {
		SERVER_HOSTS: {
			FE_HOST: 'http://localhost.gruppoitas.it:8887/?refresh',
			API_COMMON: 'http://assvi21.gruppoitas.local:8080/nfc/',
			// API_COMMON: 'http://localhost.gruppoitas.local:8080/nfc/',
			// API_COMMON: 'https://rpnfc2int.gruppoitas.it/nfc/',
			API_ALT1: 'http://localhost.gruppoitas.it:3000/',
			// SSO_URL:
			// 'https://rpssoint.gruppoitas.it/openam/UI/Login?realm=itasnet&goto='
			// #INTEGRAZIONE
			SSO_URL: 'https://rpssosvi.gruppoitas.it/openam/UI/Login?realm=intranet&goto='
		},
		LOCALES: {
			preferredLocale: 'it'
		},
